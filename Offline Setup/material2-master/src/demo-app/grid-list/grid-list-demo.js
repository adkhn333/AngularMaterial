System.register(['@angular/core', '@angular2-material/grid-list/grid-list', '@angular2-material/button/button', '@angular2-material/card/card'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, grid_list_1, button_1, card_1;
    var GridListDemo;
    return {
        setters:[
            function (core_1_1) {
