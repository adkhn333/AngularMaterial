System.register(['@angular/core/testing', '@angular/compiler/testing', '@angular/core', './portal-directives', './portal', './dom-portal-host'], function(exports_1, context_1) {
    "use strict";
    ...
    var testing_1, testing_2, core_1, portal_directives_1, portal_1, dom_portal_host_1;
    var PizzaMsg, ArbitraryViewContainerRefComponent, PortalTestApp;
    function main() {
    ...
    return {
        ...
        execute: function() {
            ...
            ArbitraryViewContainerRefComponent = (function () {
