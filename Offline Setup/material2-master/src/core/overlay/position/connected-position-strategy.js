System.register(['@angular2-material/core/style/apply-transform', './connected-position'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var apply_transform_1, connected_position_1;
    var ConnectedPositionStrategy;
    return {
        setters:[
            function (apply_transform_1_1) {
                apply_transform_1 = apply_transform_1_1;
            },
            function (connected_position_1_1) {
                connected_position_1 = connected_position_1_1;
            }],
        execute: function() {
            /**
            ...
            exports_1("ConnectedPositionStrategy", ConnectedPositionStrategy);
        }
    }
});
