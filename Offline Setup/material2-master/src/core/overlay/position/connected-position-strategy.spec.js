System.register(['@angular/core/testing', './viewport-ruler', './overlay-position-builder'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var testing_1, viewport_ruler_1, overlay_position_builder_1;
    var DEFAULT_HEIGHT, DEFAULT_WIDTH, FakeViewportRuler, FakeElementRef;
    function main() {
