System.register(['@angular/core/testing', '@angular/compiler/testing', './tab-group', '@angular/core', '@angular/platform-browser'], function(exports_1, context_1) {
    "use strict";
    ...
    var testing_1, testing_2, tab_group_1, core_1, platform_browser_1;
    var SimpleTabsTestApp;
    return {
        setters:[
            ...
            SimpleTabsTestApp = (function () {
                ...
                SimpleTabsTestApp = __decorate([
                    core_1.Component({
                        ...
                        directives: [tab_group_1.MD_TAB_GROUP_DIRECTIVES]
                    }), 
