System.register(['@angular/core', './grid-tile', './tile-coordinator', './tile-styler', './grid-list-errors', '@angular2-material/core/rtl/dir'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, grid_tile_1, tile_coordinator_1, tile_styler_1, grid_list_errors_1, dir_1;
    var MD_FIT_MODE, MdGridList, MD_GRID_LIST_DIRECTIVES;
    /**
    ...
    exports_1("coerceToString", coerceToString);
    /**
    ...
    exports_1("coerceToNumber", coerceToNumber);
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
            ...
            function (tile_coordinator_1_1) {
                tile_coordinator_1 = tile_coordinator_1_1;
            },
            function (tile_styler_1_1) {
                tile_styler_1 = tile_styler_1_1;
            },
            function (grid_list_errors_1_1) {
                grid_list_errors_1 = grid_list_errors_1_1;
            },
            function (dir_1_1) {
                dir_1 = dir_1_1;
            }],
        execute: function() {
            ...
            MdGridList = (function () {
                ...
                MdGridList = __decorate([
                    ...
                    __metadata('design:paramtypes', [core_1.Renderer, core_1.ElementRef, (typeof (_a = typeof dir_1.Dir !== 'undefined' && dir_1.Dir) === 'function' && _a) || Object])
                ], MdGridList);
                return MdGridList;
                var _a;
            }());
            exports_1("MdGridList", MdGridList);
            exports_1("MD_GRID_LIST_DIRECTIVES", MD_GRID_LIST_DIRECTIVES = [MdGridList, grid_tile_1.MdGridTile]);
        }
    }
});
