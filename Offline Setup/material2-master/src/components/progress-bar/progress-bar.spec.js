System.register(['@angular/core/testing', '@angular/compiler/testing', '@angular/core', '@angular/platform-browser', './progress-bar'], function(exports_1, context_1) {
    "use strict";
    ...
    var testing_1, testing_2, core_1, platform_browser_1, progress_bar_1;
    var TestApp;
    function main() {
