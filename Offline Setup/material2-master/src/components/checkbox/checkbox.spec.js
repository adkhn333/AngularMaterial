System.register(['@angular/core/testing', '@angular/common', '@angular/compiler/testing', '@angular/core', '@angular/platform-browser', './checkbox', '@angular2-material/core/async/promise-completer'], function(exports_1, context_1) {
    "use strict";
    ...
    var testing_1, common_1, testing_2, core_1, platform_browser_1, checkbox_1, promise_completer_1;
    var SingleCheckbox, CheckboxWithFormDirectives, MultipleCheckboxes, CheckboxWithTabIndex, CheckboxWithAriaLabel, CheckboxWithAriaLabelledby, CheckboxWithNameAttribute;
    return {
        setters:[
        ...
        execute: function() {
            ...
            CheckboxWithFormDirectives = (function () {
            ...
            CheckboxWithAriaLabel = (function () {
            ...
            /** Simple test component with an aria-label set. */
            CheckboxWithAriaLabelledby = (function () {
            ...
            CheckboxWithNameAttribute = (function () {
