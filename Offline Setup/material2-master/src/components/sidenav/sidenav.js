System.register(['@angular/core', '@angular2-material/core/rtl/dir', '@angular2-material/core/async/promise-completer', '@angular2-material/core/errors/error', '@angular2-material/core/annotations/field-value'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, dir_1, promise_completer_1, error_1, field_value_1;
    var MdDuplicatedSidenavError, MdSidenav, MdSidenavLayout, MD_SIDENAV_DIRECTIVES;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
            ...
            function (promise_completer_1_1) {
                promise_completer_1 = promise_completer_1_1;
            },
            function (error_1_1) {
                error_1 = error_1_1;
            },
        ...
        execute: function() {
            ...
            MdDuplicatedSidenavError = (function (_super) {
            ...
            exports_1("MdDuplicatedSidenavError", MdDuplicatedSidenavError);
            /**
            ...
            MdSidenavLayout = (function () {
                ...
                */
                ...
                MdSidenavLayout = __decorate([
                    ...
                    __metadata('design:paramtypes', [(typeof (_a = typeof dir_1.Dir !== 'undefined' && dir_1.Dir) === 'function' && _a) || Object, core_1.ElementRef, core_1.Renderer])
                ], MdSidenavLayout);
                return MdSidenavLayout;
                var _a;
            }());
            exports_1("MdSidenavLayout", MdSidenavLayout);
            exports_1("MD_SIDENAV_DIRECTIVES", MD_SIDENAV_DIRECTIVES = [MdSidenavLayout, MdSidenav]);
        }
    }
});
