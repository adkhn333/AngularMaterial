System.register(['@angular/core/testing', '@angular/compiler/testing', '@angular/compiler', '@angular/core', '@angular/platform-browser', './sidenav'], function(exports_1, context_1) {
    "use strict";
    ...
    var testing_1, testing_2, compiler_1, core_1, platform_browser_1, sidenav_1;
    var SidenavLayoutNoSidenavTestApp, SidenavLayoutTwoSidenavTestApp, BasicTestApp;
    ...
    return {
        ...
        execute: function() {
            ...
            SidenavLayoutNoSidenavTestApp = (function () {
            ...
            SidenavLayoutTwoSidenavTestApp = (function () {
