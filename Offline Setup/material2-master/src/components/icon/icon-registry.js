System.register(['@angular/core', '@angular/http', '@angular2-material/core/errors/error', 'rxjs/Observable', 'rxjs/add/observable/forkJoin', 'rxjs/add/observable/of', 'rxjs/add/operator/map', 'rxjs/add/operator/filter', 'rxjs/add/operator/do', 'rxjs/add/operator/share', 'rxjs/add/operator/finally', 'rxjs/add/operator/catch'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, error_1, Observable_1;
    var MdIconNameNotFoundError, MdIconSvgTagNotFoundError, SvgIconConfig, iconKey, MdIconRegistry;
    ...
    return {
        ...
        execute: function() {
            ...
            MdIconNameNotFoundError = (function (_super) {
            ...
            exports_1("MdIconNameNotFoundError", MdIconNameNotFoundError);
            /**
             * Exception thrown when attempting to load SVG content that does not contain the expected
             * <svg> tag.
             */
            MdIconSvgTagNotFoundError = (function (_super) {
            ...
            exports_1("MdIconSvgTagNotFoundError", MdIconSvgTagNotFoundError);
            /**
            ...
            iconKey = function (namespace, name) { return namespace + ':' + name; };
            /**
            ...
            exports_1("MdIconRegistry", MdIconRegistry);
        }
    }
});
