System.register(['@angular/core/testing', '@angular/compiler/testing', '@angular/http', '@angular/http/testing', '@angular/core', './icon', './icon-registry', './fake-svgs'], function(exports_1, context_1) {
    "use strict";
    ...
    var testing_1, testing_2, http_1, testing_3, core_1, icon_1, icon_registry_1, fake_svgs_1;
    var sortedClassNames, verifyAndGetSingleSvgChild, verifyPathChildElement, MdIconLigatureTestApp, MdIconLigatureWithAriaBindingTestApp, MdIconCustomFontCssTestApp, MdIconFromSvgUrlTestApp, MdIconFromSvgNameTestApp;
    function main() {
    ...
    return {
        setters:[
            ...
            function (fake_svgs_1_1) {
                fake_svgs_1 = fake_svgs_1_1;
            }],
        execute: function() {
            /** Returns the CSS classes assigned to an element as a sorted array. */
            sortedClassNames = function (elem) { return elem.className.split(' ').sort(); };
            /**
             * Verifies that an element contains a single <svg> child element, and returns that child.
             */
            verifyAndGetSingleSvgChild = function (element) {
             ...
             * the specified value.
             */
            verifyPathChildElement = function (element, attributeValue) {
                testing_1.expect(element.childNodes.length).toBe(1);
            ...
            MdIconLigatureTestApp = (function () {
            ...
            MdIconLigatureWithAriaBindingTestApp = (function () {
            ...
            MdIconCustomFontCssTestApp = (function () {
            ...
            MdIconFromSvgUrlTestApp = (function () {
            ...
            MdIconFromSvgNameTestApp = (function () {
