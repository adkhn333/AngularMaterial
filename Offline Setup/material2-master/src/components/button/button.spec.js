System.register(['@angular/core/testing', '@angular/compiler/testing', '@angular/core', '@angular/platform-browser', './button'], function(exports_1, context_1) {
    "use strict";
    ...
    var testing_1, testing_2, core_1, platform_browser_1, button_1;
    var TestApp;
    function main() {
