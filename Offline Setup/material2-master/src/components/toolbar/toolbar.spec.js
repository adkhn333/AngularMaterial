System.register(['@angular/core', '@angular/core/testing', '@angular/compiler/testing', '@angular/platform-browser', './toolbar'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, testing_1, testing_2, platform_browser_1, toolbar_1;
    var TestApp;
    function main() {
